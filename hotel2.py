...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        self.h1=QLabel("Special Talli    ₹160",self.frame1)
        ...
        self.i2.setPixmap(QPixmap('chicken.jpg'))
        self.i2.resize(self.i1.width(),self.i1.height())
        
        self.h2=QLabel("Chicken Lollipop    ₹140",self.frame2)
        ...
        self.h3=QLabel("Burger    ₹80",self.frame3)
        ...
        self.i4.setPixmap(QPixmap('pasta.jpg'))
        self.i4.resize(self.i1.width(),self.i1.height())
        
        self.h4=QLabel("Pasta    ₹100",self.frame4)
    ...
    def hotel1(self):
        ...
        print(now)
        vala = ('Special thalli','Ram hotel','160',now)
    ...
    def hotel2(self):
        ...
        now = QDate.currentDate().toPyDate()
        print(now)
        vala = ('Chicken  lollipop','Ram hotel','140',now)
        mycu.execute(que, vala)
        conn.commit()
        QMessageBox.question(self,'Ram hotel', "Food added to list")
